export const COPPER_PRODUCTS = [
  {
    ...
    status: "sold",
    keywords: {
      ar: "شيشة نحاس تراثية, شيشة قديمة, شيشة أثرية, تحف نحاسية, شيشة عراقية قديمة, قطعة تراثية, ديكور تراثي, مقتنيات نادرة, بيت التحفيات, تحف بغداد",
      en: "heritage copper hookah, antique hookah, vintage copper hookah, copper antiques, heritage décor, collectible hookah, rare antique piece, House of Antiques Baghdad, old copper display piece",
      ku: "nargîleya misî mîrasî, nargîleya kevn, antîka misî, parça mîrasî, dîkorê mîrasî, tiştê koleksiyonî, antîkayên nâdir, House of Antiques Baghdad"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-07-hookah_qilfmy"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-07-hookah_qilfmy"
  },
  {
    id: "HOA-COP-009",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "هاون نحاس, مدقة نحاس, أدوات تراثية, نحاس عراقي, تحف يهود العراق, هاون أعشاب قديم, مقتنيات تراثية, تحف نادرة, بيت التحفيات, ديكور تراثي",
      en: "copper mortar set, antique copper mortar, Iraqi Jewish craft, heritage copper tools, vintage herb mortar, collectible copper piece, rare antiques, House of Antiques Baghdad",
      ku: "havên misî, antîka misî, amûrên mîrasî, hunera cihûyên Iraqê, havêna gihayî kevn, parça koleksiyonî, dîkorê mîrasî"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-09-brass-knockers_ysriwj"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-09-brass-knockers_ysriwj"
  },
  {
    id: "HOA-COP-037",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "إبريق نحاس, إبريق تراثي, نحاس مزخرف, إبريق يدوي, تحف نحاسية, ديكور شرقي, تحف قديمة, بيت التحفيات, مقتنيات تراثية, إبريق أنتيك",
      en: "heritage copper pitcher, antique copper pitcher, hand engraved copper, oriental décor, copper antique, collectible pitcher, museum display piece, House of Antiques Baghdad",
      ku: "îbrîqê misî, îbrîqê mîrasî, misê xiştkirî, antîka misî, dîkorê rojhilatî, parça koleksiyonî, parça muzexaneyî"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-037_ohqzfa"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-037_ohqzfa"
  },
  {
    id: "HOA-slv-012",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "سيت نحاس, طقم نحاس تراثي, 3 قطع نحاس, نقش يدوي, تحف عراقية قديمة, ديكور تراثي, مقتنيات نحاسية, بيت التحفيات, تحف نادرة",
      en: "heritage copper set, antique copper set, hand engraved copper, 3 piece copper set, Iraqi heritage décor, vintage copperware, collectible antiques, House of Antiques Baghdad",
      ku: "seta misî, komela misî mîrasî, sê parçe misî, dest-nexşkirî, dîkorê mîrasî, antîkayên Iraqî, parça koleksiyonî"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-slv-012_xgwe2n"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-slv-012_xgwe2n",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "سماور روسي, سماور روسي أصلي, سماور قديم, سماور أنتيك, تحف روسية, سماور شاي, مقتنيات تراثية, بيت التحفيات, سماور مزخرف, تحف نادرة",
      en: "Russian samovar, antique Russian samovar, vintage samovar, tea samovar, collectible samovar, heritage antiques, luxury antique décor, House of Antiques Baghdad",
      ku: "samovar rusî, samovar kevn, samovar antîk, samovar çayê, tiştên mîrasî, antîka lüks, parça koleksiyonî"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-021_jqy8fq",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-021-1_sutm3d"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-021_jqy8fq",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "وعاء نحاس, وعاء نحاسي قديم, تحف نحاسية, نقش يدوي, ديكور تراثي, فازة نحاسية, قطعة متحفية, بيت التحفيات, تحف نادرة, أواني نحاسية",
      en: "antique copper bowl, heritage copper bowl, hand engraved copper, copper vase, museum display piece, luxury heritage décor, collectible copperware, House of Antiques Baghdad",
      ku: "qapê misî, qapê kevn, misî dest-nexşkirî, dîkorê mîrasî, fazeya misî, parça muzexaneyî, tiştê koleksiyonî"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-slv-030_mdcjln"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-slv-030_mdcjln",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "مدقات باب نحاس, دقاقات باب تراثية, أبواب تراثية, نحاس قديم, تحف معمارية, اكسسوارات أبواب, تحف نادرة, بيت التحفيات, ديكور تراثي, باب نحاسي",
      en: "copper door knockers, heritage door knockers, antique architectural hardware, vintage copper décor, collectible antique door pieces, House of Antiques Baghdad",
      ku: "medeqey dergay misî, dergaya mîrasî, antîka me'marî, dîkorê kevn, parçeyên derga, tiştê koleksiyonî"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-061_knrhua"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-061_knrhua",
    material: {
      ar: "نحاس",
      en: "Copper",
      ku: "نەحاس"
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "سماور عثماني, سماور نحاس, سماور قديم, سماور تراثي, تحف عثمانية, نحاس عثماني, قطعة متحفية, بيت التحفيات, تحف نادرة, سماور أنتيك",
      en: "Ottoman copper samovar, antique samovar, heritage copper samovar, Ottoman antiques, collectible copperware, museum display piece, House of Antiques Baghdad",
      ku: "samovar osmanî, samovar misî, samovar kevn, antîka osmanî, parçeyên mîrasî, parça muzexaneyî, tiştê koleksiyonî"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-095_p3hux2",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-096_vnfdwl"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-095_p3hux2",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "شمعدان نحاس, شمعدانات أنتيك, شمعدان طويل, تحف أوروبية, ديكور فاخر, نحاس قديم, قطع متحفية, بيت التحفيات, تحف نادرة, شمعدان تراثي",
      en: "antique copper candlesticks, tall copper candlesticks, vintage candle holders, European antique décor, museum display piece, luxury heritage décor, House of Antiques Baghdad",
      ku: "şimedanê misî, du şimedan antîk, şimedanê dirêj, dîkorê ewropî kevn, parça muzexaneyî, dîkorê lüks"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-094_wbhcun"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-094_wbhcun",
    createdAt: "2026-01-08"
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "إبريق نحاس أنتيك, إبريق تراثي, إبريق مزخرف, نحاس قديم, ديكور تراثي فاخر, تحف نحاسية, قطعة متحفية, بيت التحفيات, مقتنيات نادرة",
      en: "antique copper pitcher, vintage copper jug, heritage copper décor, hand hammered copper, museum display piece, collectible antique décor, House of Antiques Baghdad",
      ku: "îbrîqê antîk, îbrîqê misî, dîkorê mîrasî, misî ledan-destî, parça muzexaneyî, antîka koleksiyonî"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-109_x3vwxq"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-109_x3vwxq",
    createdAt: "2026-01-08"
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "موقد نحاس أثري, موقد نحاسي قديم, إبريق نحاس, قطعة متحفية, تحف نادرة, نحاس أثري, ديكور تراثي فاخر, بيت التحفيات, تحف القرن التاسع عشر",
      en: "antique copper burner, standing copper burner, antique copper pitcher, museum-worthy copper piece, 19th century copperware, rare heritage décor, House of Antiques Baghdad",
      ku: "moqedê misî antîk, suxtkerê misî, îbrîqê antîk, parça muzexaneyî, antîka sedsala 19an, dîkorê mîrasî"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-111_mytxio",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-111-1_rpbskz"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-111_mytxio",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "إبريق قهوة عثماني, دلة نحاس عثمانية, قهوة عربية تراثية, تحف عثمانية, نحاس قديم, إبريق قهوة أنتيك, قطعة متحفية, بيت التحفيات, تحف نادرة",
      en: "Ottoman copper coffee pot, antique coffee pot, heritage copper dallah, Arabic coffee pot, Turkish coffee antique, museum display piece, House of Antiques Baghdad",
      ku: "îbrîqê qehweya osmanî, delleya misî, qehweya erebî, antîka osmanî, parça muzexaneyî, tiştê koleksiyonî"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-122_fkkhcj"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-122_fkkhcj",
    createdAt: "2026-01-09"
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "دلال قهوة عثمانية, طقم دلال نحاس, قهوة عثمانية, دلال تراثية, نحاس عثماني, تحف نادرة, مقتنيات فاخرة, بيت التحفيات, تحف متحفية, طقم قهوة أنتيك",
      en: "Ottoman copper coffee pot set, antique dallah set, heritage coffee set, Ottoman copperware, collectible antique coffee pots, luxury heritage décor, House of Antiques Baghdad",
      ku: "seta delleya qehweya osmanî, misî osmanî, qehweya mîrasî, dela kevn, tiştê koleksiyonî, dîkorê lüks"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-115_m0sgch",
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-115_m0sgch",
    createdAt: "2026-01-09"
  },
  {
  ...
  status: "available",
  keywords: {
    ar: "قطعة نحاس بغطاء, نحاس مزخرف, تحف نحاسية, قطعة نحاس تراثية, غطاء متحرك, نحاس أنتيك, ديكور تراثي, بيت التحفيات, تحف نادرة, نحاس كلاسيكي",
    en: "antique copper piece, copper vessel with lid, hinged copper lid, decorative copper antique, classical copper décor, museum display copper, House of Antiques Baghdad, rare copper collectible",
    ku: "parçeyê misî bi qapax, misî antîk, misî razênraw, dekorê mîrasî, qapaxê joław, parça koleksiyonî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-098_ypovbx"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-098_ypovbx",
  createdAt: "2026-01-09"
},
{
  ...
  status: "available",
  keywords: {
    ar: "وعاء نحاس بغطاء, وعاء نحاسي مزخرف, نحاس شرقي, تحف نحاسية, وعاء دائري, نحاس أنتيك, بيت التحفيات, ديكور شرقي, تحف نادرة, وعاء تراثي",
    en: "antique copper bowl, copper bowl with lid, circular copper lid, eastern copper décor, decorative copper vessel, museum display copper, House of Antiques Baghdad, rare antique bowl",
    ku: "qapê misî bi qapax, qapê misî razênraw, misî rojhilatî, dekorê mîrasî, qapê bazneî, antîka misî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-097_dxlx35"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-097_dxlx35",
  createdAt: "2026-01-09"
},
{
  ...
  status: "available",
  keywords: {
    ar: "سماور مغولي, سماور ضخم, سماور كهرمان, سماور نحاس فاخر, تحف ملكية, تحف نادرة, بيت التحفيات, سماور مزخرف, مقتنيات فاخرة, سماور أنتيك",
    en: "Mughal samovar, large copper samovar, amber inlaid samovar, luxury antique samovar, royal copper décor, museum showcase piece, House of Antiques Baghdad, rare samovar collectible",
    ku: "samovarê meğolî, samovarê mezin, samovar bi kehruba, misî lüks, parçeyê şahaneyî, antîka nâdir, House of Antiques Baghdad"
  },
  featured: true,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-110_ww2mxh",
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-110-2_bnlqrx",
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-110-1_bc8k6d"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-110_ww2mxh",
  createdAt: "2026-01-09"
},
{
  ...
  status: "available",
  keywords: {
    ar: "سماور نحاسي دائري, سماور نحاس, سماور تراثي, تحف نحاسية, سماور أنتيك, ديكور تراثي, بيت التحفيات, سماور كلاسيكي, تحف نادرة",
    en: "round copper samovar, antique copper samovar, classical samovar, heritage copper décor, museum display samovar, House of Antiques Baghdad, vintage samovar collectible",
    ku: "samovarê misî bazneî, samovarê antîk, samovarê mîrasî, dekorê klasîk, House of Antiques Baghdad, parça koleksiyonî"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-092_mbpia3"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-092_mbpia3",
  createdAt: "2026-01-09"
},
{
  ...
  status: "available",
  keywords: {
    ar: "سماور كلاسيكي, سماور نحاسي مزخرف, سماور أنتيك, تحف نحاسية, سماور تراثي, ديكور كلاسيكي, بيت التحفيات, سماور قديم, تحف نادرة",
    en: "classical copper samovar, decorated antique samovar, heritage copper samovar, museum display samovar, vintage copper décor, House of Antiques Baghdad",
    ku: "samovarê klasîk, samovarê misî razênraw, samovarê antîk, dekorê mîrasî, House of Antiques Baghdad, parça kevn"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-91_zhykcb"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-91_zhykcb",
  createdAt: "2026-01-09"
},
{
  id: "HOA-COP-138",
  ...
  status: "available",
  keywords: {
    ar: "قطعة نحاس تراثية, وعاء نحاسي, نحاس قديم, تحف نحاسية, ديكور تراثي, مقتنيات قديمة, بيت التحفيات, نحاس كلاسيكي",
    en: "traditional copper vessel, antique copper piece, heritage copper décor, rounded copper pot, museum display copper, House of Antiques Baghdad",
    ku: "parçeyê misî kelapûrî, qapê misî, misî kevn, dekorê mîrasî, House of Antiques Baghdad, parça dîrokî"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-138_tuzxt4"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-138_tuzxt4",
  material: {
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "شمعدان نحاس, شمعدان تراثي, شمعدان كلاسيكي, تحف نحاسية, ديكور تراثي, قطعة متحفية, بيت التحفيات, شمعدان مزخرف",
    en: "traditional copper candelabrum, antique copper candlestick, heritage candelabrum, museum display décor, House of Antiques Baghdad, classical copper lighting piece",
    ku: "şimedanê misî, şimedanê kelapûrî, dekorê klasîk, parça muzexaneyî, House of Antiques Baghdad, şimedanê razênraw"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-144_sjkgij"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-144_sjkgij",
  material: {
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "قطعة نحاس مزخرفة, نحاس تراثي, تحف نحاسية, ديكور كلاسيكي, قطعة نحاس قديمة, بيت التحفيات, تحف مميزة, نحاس أنتيك",
    en: "decorative antique copper piece, heritage copper décor, raised floral copper, museum display object, House of Antiques Baghdad, vintage copper collectible",
    ku: "parçeyê misî razênraw, misî kelapûrî, dekorê klasîk, parça kevn, House of Antiques Baghdad, antîka misî"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-139_nq2ome"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-139_nq2ome",
  material: {
    ar: "نحاس مصبوب ومزخرف يدويًا",
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "قكة نحاس, قكة منقوشة, نحاس تراثي, إبريق نحاس, تحف نحاسية, ديكور تراثي, بيت التحفيات, قطعة متحفية, نحاس فاخر",
    en: "engraved copper ewer, traditional copper vessel, heritage copper décor, antique copper pitcher, museum display copper, House of Antiques Baghdad, luxury copper collectible",
    ku: "qikeya misî, misî neqişkirî, îbrîqê misî, dekorê mîrasî, House of Antiques Baghdad, parça muzexaneyî"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-125_zufybx"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-125_zufybx",
  material: {
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "إبريق نحاس, إبريق منقوش, نحاس تراثي, تحف نحاسية, إبريق قديم, ديكور كلاسيكي, بيت التحفيات, نحاس أنتيك",
    en: "engraved copper ewer, antique copper pitcher, heritage copper vessel, museum display décor, House of Antiques Baghdad, hand engraved copper collectible",
    ku: "îbrîqê misî, misî neqişkirî, antîka misî, dekorê klasîk, House of Antiques Baghdad, parça mîrasî"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-126_iywquf"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-126_iywquf",
  material: {
    ar: "نحاس منقوش يدويًا",
    en: "Hand-Engraved Copper",
    ku: "مسی بە دەست نەقشکراو"
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "قطعة نحاس منقوشة, وعاء نحاسي, نحاس تراثي, تحف نحاسية, ديكور تراثي, نحاس كلاسيكي, بيت التحفيات, قطعة متحفية",
    en: "engraved copper bowl, traditional copper piece, antique copper décor, floral engraved copper, museum display copper, House of Antiques Baghdad, heritage collectible",
    ku: "parçeyê misî neqişkirî, qapê misî, dekorê mîrasî, misî kelapûrî, House of Antiques Baghdad, parça dîrokî"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-137_tpwkm6"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-137_tpwkm6",
  material: {
    ar: "نحاس منقوش يدويًا",
    en: "Hand-Engraved Copper",
    ku: "مسی بە دەست نەقشکراو"
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "مصباح منضدي, مصباح نحاس, زجاج ملون, ديكور تراثي, إضاءة كلاسيكية, مصباح قديم, بيت التحفيات, قاعدة نحاسية",
    en: "table lamp, brass base lamp, stained glass lamp, classic heritage lighting, decorative antique lamp, House of Antiques Baghdad",
    ku: "çiray serbanî, çiray misî, şîşeya rengîn, ronakîya klasîk, dekorê mîrasî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-136-1_kr56wl"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-136-1_kr56wl",
  material: {
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "شمعدان نحاس, شمعدان صغير, تحف نحاسية, ديكور تراثي, شمعدان كلاسيكي, بيت التحفيات, شمعدان مزخرف",
    en: "decorative brass candlestick, small copper candlestick, antique candle holder, museum display décor, House of Antiques Baghdad, heritage lighting piece",
    ku: "şimedanê misî, şimedanê biçûk, dekorê mîrasî, şimedanê klasîk, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-132_pnx1di"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-132_pnx1di",
  material: {
    ar: "نحاس مصبوب ومزخرف يدويًا",
    en: "Cast and Decorated Copper",
    ku: "مسی داڕێژراو و بە دەست ڕازێنراو"
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "زوج شمعدانات نحاس, شمعدانات مزخرفة, تحف نحاسية, ديكور تراثي, شمعدانات كلاسيكية, بيت التحفيات, زوج شمعدان قديم",
    en: "pair of decorative copper candlesticks, antique copper candle holders, heritage décor pair, museum display candlesticks, House of Antiques Baghdad",
    ku: "du şimedanê misî, şimedanên razênraw, dekorê mîrasî, cota şimedan, House of Antiques Baghdad, parça kevn"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-131_xewxae"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-131_xewxae",
  material: {
    ar: "نحاس مصبوب ومزخرف يدويًا",
    en: "Cast and Decorated Copper",
    ku: "مسی داڕێژراو و بە دەست ڕازێنراو"
  ...
  status: "available",
  keywords: {
    ar: "وعاء نحاس, وعاء مزخرف, نحاس تراثي, تحف نحاسية, ديكور كلاسيكي, قطعة متحفية, بيت التحفيات, نحاس أنتيك",
    en: "copper bowl with legs, decorative copper vessel, antique copper décor, heritage copper piece, museum display item, House of Antiques Baghdad",
    ku: "qapê misî, misî razênraw, dekorê mîrasî, parça antîk, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-128_d6fjfc"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-128_d6fjfc",
  material: {
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "سماور نحاس, سماور تراثي, سماور شاي, تحف نحاسية, ديكور تراثي, بيت التحفيات, سماور قديم",
    en: "traditional copper samovar, antique samovar, tea samovar copper, heritage décor, museum display samovar, House of Antiques Baghdad",
    ku: "samovarê misî, samovarê kelapûrî, samovarê çay, dekorê mîrasî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-175_hclgt3"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-sam-175_hclgt3"
},
{
  id: "HOA-COP-154",
  category: {
  ...
  desc: {
    ...
    ku: "شمعدانێکی نەریتی لە مس بە دوو قۆڵ، دیزاینێکی کلاسیکی سادە هەیە، گونجاو بۆ دیکۆری مێژوویی یان کۆمەڵە کلاسیکی."
  },
  priceNumber: 31,
  currency: "USD",
  price: "$31",
  status: "available",
  keywords: {
    ar: "شمعدان نحاس مزدوج, شمعدان تراثي, تحف نحاسية, ديكور كلاسيكي, شموع, بيت التحفيات",
    en: "double arm copper candelabra, antique candlestick, heritage décor, copper candle holder, House of Antiques Baghdad",
    ku: "şimedanê misî du qoll, şimedanê kelapûrî, dekorê klasîk, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-154_wppqtm",
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-154-1_a15sde"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-154_wppqtm"
},
{
  id: "HOA-COP-172",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "إبريق نحاس, إبريق تراثي, نحاس قديم, تحف نحاسية, ديكور, ضيافة, بيت التحفيات",
    en: "vintage copper ewer, antique copper pitcher, heritage décor, copper serving vessel, House of Antiques Baghdad",
    ku: "îbrîqê misî, antîka misî, dekorê mîrasî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-172_ki4jrg"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-172_ki4jrg"
},
  {
  id: "HOA-COP-157",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "شمعدان نحاس, شمعدان كبير, حامل شموع نحاسي, ديكور تراثي, تحف نحاسية, شمعدان كلاسيكي, بيت التحفيات",
    en: "large copper candle holder, antique copper candlestick, heritage décor, classic candle holder, House of Antiques Baghdad",
    ku: "şemdanê misî, şemdanê mezin, dekorê mîrasî, şemdanê klasîk, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-157_cyoucw"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-157_cyoucw",
  material: {
    ar: "نحاس",
    en: "Copper",
    ku: "مس"
...
},
{
  ...
  status: "available",
  keywords: {
    ar: "سماور أنتيك, سماور نحاس, سماور مزخرف, سماور تراثي, تحف نحاسية, ديكور كلاسيكي, بيت التحفيات",
    en: "antique metal samovar, decorative samovar, heritage tea samovar, antique copper décor, House of Antiques Baghdad",
    ku: "samovarê antîk, samovarê misî, samovarê razênraw, dekorê klasîk, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-191_ywmbie"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-191_ywmbie"
},
{
  id: "HOA-COP-222",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "قطعة تقديم نحاس, صحن تقديم نحاسي, ديكور تراثي, تحف نحاسية, تقديم حلويات, بيت التحفيات",
    en: "copper serving stand, decorative copper tray, antique serving piece, heritage décor, House of Antiques Baghdad",
    ku: "parçeya pêşkêşkirinê misî, dekorê mîrasî, misî antîk, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-222_yah7jp"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-222_yah7jp"
},
{
  id: "HOA-COP-200",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "دلة قهوة نحاس, دلة أنتيك, قهوة عربية, تحف نحاسية, ضيافة عربية, بيت التحفيات",
    en: "antique copper dallah, Arabic coffee pot, heritage coffee server, copper antique, House of Antiques Baghdad",
    ku: "delleya qehweyê misî, qehweya erebî, antîka misî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-200_wmoiof"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-200_wmoiof"
},
{
  id: "HOA-COP-201",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "قطعة تقديم نحاسية, وعاء تقديم, نحاس أنتيك, تحف نحاسية, ديكور كلاسيكي, بيت التحفيات",
    en: "antique copper serving bowl, decorative serving dish, heritage copper décor, House of Antiques Baghdad",
    ku: "qasa pêşkêşkirinê misî, misî antîk, dekorê klasîk, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-201_zixbcq"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-201_zixbcq"
},
{
  id: "HOA-COP-204",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "إبريق نحاس, إبريق أنتيك, نحاس قديم, أواني تراثية, ديكور شرقي, بيت التحفيات",
    en: "antique copper ewer, vintage copper pitcher, heritage water vessel, House of Antiques Baghdad",
    ku: "îbrîqê misî antîk, qasaya avê kevn, dekorê mîrasî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-204_aqcwcw"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-204_aqcwcw"
},
{
  id: "HOA-COP-209",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "قطعة نحاس فريدة, نحاس منقوش, تحف نادرة, ديكور فاخر, مقتنيات تراثية, بيت التحفيات",
    en: "unique engraved antique copper piece, rare copper collectible, luxury heritage décor, House of Antiques Baghdad",
    ku: "parçeya misî taybet, misî neqşkirî, antîka nâyab, House of Antiques Baghdad"
  },
  featured: true,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-209_art1u1"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-209_art1u1"
},
{
  id: "HOA-COP-213",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "وعاء نحاس فاخر, وعاء مزخرف, نحاس أنتيك, تحف فاخرة, ديكور كلاسيكي, بيت التحفيات",
    en: "unique ornate copper bowl, luxury antique copper, rare display bowl, House of Antiques Baghdad",
    ku: "kaseya misî fexm, misî antîk, dekorê klasîk, House of Antiques Baghdad"
  },
  featured: true,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-213_d1z8b9"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-213_d1z8b9"
},
{
  id: "HOA-COP-215",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "ركية حمام, ركية نحاس, أدوات حمام تراثية, تحف شعبية, مقتنيات عراقية قديمة, بيت التحفيات",
    en: "traditional copper hammam container, rakiya, bathhouse heritage piece, Iraqi heritage antique, House of Antiques Baghdad",
    ku: "rakiya misî, amûrên germavê, antîka Iraqî, House of Antiques Baghdad"
  },
  featured: true,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-215_qchty0"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-215_qchty0"
},
{
  id: "HOA-COP-216",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "ركية نحاس, ركية حمام, أدوات تراثية عراقية, تحف قديمة, حمام السوق, بيت التحفيات",
    en: "traditional copper rakiya, hammam container, Iraqi social heritage antique, House of Antiques Baghdad",
    ku: "rakiya misî, germav, antîka mîrasî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-216_v4xmt4"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-216_v4xmt4"
},
{
  id: "HOA-COP-225",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "قطعة نحاس أنتيك, قطعة تقديم تراثية, نحاس قديم, تحف نحاسية, ديكور متحفي, بيت التحفيات",
    en: "unique antique copper piece, heritage serving item, museum style copper décor, House of Antiques Baghdad",
    ku: "parçeya misî antîk, dekorê muzexaneyî, misî kevn, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-225_z6asaj"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-225_z6asaj"
},
{
  id: "HOA-COP-253",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "كأس نحاسي, كأس أنتيك, تحف نحاسية, قطعة تراثية, ديكور نحاسي, بيت التحفيات",
    en: "antique copper cup, vintage copper vessel, decorative copper antique, House of Antiques Baghdad",
    ku: "kaseya misî antîk, parça mîrasî, dekorê misî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-253_iwte2v"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-253_iwte2v"
},
{
  id: "HOA-COP-264",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "قطعة نحاس مخرمة, فانوس نحاسي, ديكور مضيء, تحف نحاسية, زخارف هندسية, بيت التحفيات",
    en: "tall pierced copper decorative piece, copper lantern, geometric copper décor, House of Antiques Baghdad",
    ku: "misî mexrem, fanûsa misî, dekorê ronakî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-264_uirgjs"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-264_uirgjs"
},
{
  id: "HOA-COP-280",
  category: {
  ...
  status: "available",
  keywords: {
    ar: "زوج فازات نحاس, فازات كلاسيكية, ديكور شرقي, تحف نحاسية, فازات أنتيك, بيت التحفيات",
    en: "pair of classic copper vases, antique vase pair, oriental copper décor, House of Antiques Baghdad",
    ku: "du fazeya misî, fazeyên klasîk, dekorê rojhilatî, House of Antiques Baghdad"
  },
  featured: false,
  auction: false,
  images: [
    "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-280_l7acvu"
  ],
  image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cop-280_l7acvu"
}
];