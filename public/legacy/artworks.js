export const ARTWORKS_PRODUCTS = [
  {
    id: "HOA-FINE-001",
    category: {
      ar: "اعمال فنية",
    ...
    status: "available",
    keywords: {
      ar: "عمل فني حجري, منعم فرات, منحوتة حجرية, فن عراقي, قطعة نادرة, نحت قديم",
      en: "stone artwork, Mun'em Furat, stone sculpture, Iraqi art, rare sculpture, antique art",
      ku: "کاری هونەری بەردی, مۆنعم فُرات, پەیکەری بەردی, هونەری عێراقی, پارچەی دەگمەن"
    },
    featured: true,
    auction: true,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-01-stone_suqyho"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-01-stone_suqyho"
  },
  {
    id: "HOA-FINE-005",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "فازات فخارية, سيت فازات, رسم يدوي, خزف قديم, ديكور فني, أعمال فنية",
      en: "pottery vase set, hand painted pottery, antique vases, artistic decor, ceramic set, artworks",
      ku: "سێتی فازەی خەزفی, وێنەکاری دەستی, خزفی کۆن, دیکۆری هونەری, فازە"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-05-pottery-set_nsyybt"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-05-pottery-set_nsyybt"
  },
  {
    id: "HOA-FINE-006",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "عمل أفريقي, مجسم أفريقي, فن أفريقي, قطعة ديكور, عمل فني قديم, تمثال",
      en: "african artwork, african figurine, decorative sculpture, tribal art, vintage artwork, statue",
      ku: "کاری ئەفریقی, پەیکەری ئەفریقی, هونەری ئەفریقی, تمثال, پارچەی دیکۆری"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-06-african-art_yalmqs"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-06-african-art_yalmqs"
  },
  {
    id: "HOA-CER-035",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "بيضات خزفية, خزف مزخرف, قطع صغيرة, تحف دقيقة, رسوم يدوية, قواعد خشبية",
      en: "ceramic eggs, decorated ceramics, mini antiques, hand painted eggs, collectible art, wooden bases",
      ku: "هێلکەی خەزفی, خزفی ڕازاو, پارچەی بچووک, تحفی ورد, وێنەکاری دەستی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-035_nkh634"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-035_nkh634"
  },
  {
    id: "HOA-FINE-029",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "منحوتة حجرية, نحت تعبيري, فن تجريدي, عمل فني معاصر, حجر منحوت, قطعة متحفية",
      en: "stone sculpture, expressive sculpture, abstract art, contemporary artwork, carved stone, museum piece",
      ku: "پەیکەری بەردی, نحتی دەربڕینی, هونەری ئەبستراکت, کاری هونەری هاوچەرخ, بەردی نەخشکراو"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-029_whj1lj"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-029_whj1lj"
  },
  {
    id: "HOA-TRL-032",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "تمثال هيرميس, رأس كلاسيكي, فن يوناني, تمثال رخامي, ديكور فني, نحت تاريخي",
      en: "Hermes bust, classical sculpture, Greek art, marble base, artistic decor, historical statue",
      ku: "پەیکەری هێرمێس, سەری کلاسیکی, هونەری یۆنانی, بنەمای مرمەر, نحتی مێژوویی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-032_eitprd"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-032_eitprd"
  },
  {
    id: "HOA-ART-013",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "برونز, نحت تجريدي, تكوين إنساني, عمل فني, تمثال برونزي, فن معاصر",
      en: "bronze sculpture, abstract sculpture, human composition, contemporary art, bronze artwork, figurative abstraction",
      ku: "برۆنز, نحتی ئەبستراکت, پێکهاتەی مرۆیی, کاری هونەری, تمثال"
    },
    featured: true,
    auction: true,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-art-013_tb2uby"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-art-013_tb2uby",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "سيت هندي, فن هندي, رسم يدوي, ديكور تراثي, أعمال فنية, قطعة أنتيك",
      en: "indian decorative set, hand painted indian art, antique decor, heritage artwork, artistic set, vintage collectible",
      ku: "سێتی هەندی, هونەری هەندی, ڕەسراوی دەستی, دیکۆری میراثی, پارچەی کۆن"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-brz-022_pyju1k"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-brz-022_pyju1k",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "تمثال بوهيمي, عمل طقسي, تمثال نادر, فن رمزي, قطعة متحفية, نحت تعبيري",
      en: "bohemian figurine, ritual sculpture, symbolic art, rare statue, museum artwork, expressive carving",
      ku: "پەیکەرتەی بوهیمی, کاری ئایینی, تمثال دەگمەن, هونەری ڕەمزی, پارچەی مۆزەیی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-071_cwg5oh"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-071_cwg5oh",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "عمل فني موقّع, قطعة أصلية, توقيع فنان, اقتناء فني, عمل جامعي, فن تعبيري",
      en: "signed artwork, original piece, artist signature, collectible art, expressive artwork, fine art",
      ku: "کاری هونەری واژۆکراو, پارچەی ڕەسەن, مۆری هونەرمەند, کاری کۆکردنەوە"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-066_bq7jpq"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-066_bq7jpq",
    condition: {
      ar: "حالة ممتازة",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "نحت حجري, فن تجريدي, منحوتة حجرية, عمل فني معاصر, حجر طبيعي, قطعة متحفية",
      en: "abstract stone sculpture, stone art, carved stone, contemporary sculpture, natural stone artwork, museum art",
      ku: "نحتی بەردی, هونەری ئەبستراکت, پەیکەری بەردی, کاری هونەری هاوچەرخ, بەردی سرووشتی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-063_bpmkgv"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-063_bpmkgv",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "عمل فني خشبي, نحت خشبي, فن تجريدي, خشب طبيعي, عمل معاصر, قطعة فنية",
      en: "abstract wooden artwork, wood sculpture, natural wood art, contemporary art, carved wood, fine artwork",
      ku: "کاری هونەری دار, نحتی دار, هونەری ئەبستراکت, داری سرووشتی, پارچەی هونەری"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-064_q9e80m"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-064_q9e80m",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "مطرقة مزاد, خشب مزخرف, أداة مزاد, قطعة عرض, عمل فني خشبي, تحفة نادرة",
      en: "auction gavel, ornate wood, wooden collectible, art object, antique gavel, display piece",
      ku: "چکۆڵەی مزاد, داری ڕازاو, ئامرازە مزادییەکان, پارچەی پیشاندان, تحفە"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-069_qo8skc",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-6069-1_wyypg2"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-069_qo8skc",
    material: {
  ...
  },
  {
    ...
    sourceCategory: "أعمال فنية",
    name: {
      ar: "عمل فني من العاج منحوت يدويًا",
      en: "Hand-Carved Ivory Artwork",
      ku: "کاری هونەری لە عاج دەست‌تاشراو"
    },
    desc: {
    ...
    status: "available",
    keywords: {
      ar: "عاج, عمل فني, نحت, تحفة نادرة, فن أنتيك, منحوتة, ivory art, carved ivory, antique sculpture, fine art",
      en: "ivory artwork, carved ivory, antique sculpture, rare art piece, hand carved art, museum quality sculpture",
      ku: "عاج, کاری هونەری, نحت, تحفەی دەگمەن, پەیکەری کۆن, پارچەی متحفی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-124_o91phy",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-124-1_fn29tz"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-124_o91phy"
  },
  {
    id: "HOA-FINE-130",
    category: {
    ...
    sourceCategory: "أعمال فنية",
    name: {
      ar: "قطعة فنية نحتية كلاسيكية",
      en: "Classical Sculptural Art Piece",
      ku: "پارچەیەکی هونەری تاشراوی کلاسیکی"
    },
    desc: {
    ...
    status: "available",
    keywords: {
      ar: "نحت كلاسيكي, قطعة فنية, منحوتة, عمل متحفي, فن تجسيدي, ديكور فاخر",
      en: "classical sculpture, figurative art, sculptural artwork, museum style piece, fine art decor, collectible sculpture",
      ku: "نحتی کلاسیکی, پارچەی هونەری, پەیکەری, کاری متحفی, دیکۆری فاخر"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-130_ldqerk"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-130_ldqerk"
  },
  {
    id: "HOA-FINE-152",
    category: {
    ...
    sourceCategory: "أعمال فنية",
    name: {
      ar: "عمل فني خشبي منحوت",
      en: "Carved Wooden Art Piece",
      ku: "کاری هونەری دارەکی دەست‌تاشراو"
    },
    desc: {
    ...
    status: "available",
    keywords: {
      ar: "عمل فني خشبي, نحت خشب, فن تجريدي, قطعة ديكور, عمل معاصر, فن تعبيري",
      en: "carved wood art, abstract wooden sculpture, expressive artwork, wooden decor, contemporary art, gallery piece",
      ku: "کاری هونەری دار, نحتی دار, هونەری ئەبستراکت, پارچەی دیکۆری, کاری هاوچەرخ"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-152_ivcqad",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-152-1_fzxx1k"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-152_ivcqad"
  },
  {
    id: "HOA-FINE-156",
    category: {
    ...
    sourceCategory: "أعمال فنية",
    name: {
      ar: "عمل فني نَحتي تجريدي",
      en: "Abstract Sculptural Art Piece",
      ku: "کاری هونەری تاشراوی ئەبستراکت"
    },
    desc: {
    ...
    status: "available",
    keywords: {
      ar: "نحت تجريدي, عمل فني, منحوتة, فن معاصر, قطعة فنية, تشكيل يدوي",
      en: "abstract sculpture, contemporary artwork, hand formed art, sculptural piece, gallery art, fine sculpture",
      ku: "نحتی ئەبستراکت, کاری هونەری, پەیکەری, هونەری هاوچەرخ, پارچەی هونەری"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-156_qgvjur",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-156-1_dvyhfc"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-156_qgvjur"
  },
  {
    id: "HOA-FINE-185",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "جامعة كتب, خشب منحوت, مكتبة, ديكور مكتبي, قطعة فنية, عمل خشبي",
      en: "wooden bookends, carved wood, library decor, artistic bookends, wood art, desk accessory",
      ku: "پشتێنەی کتێب, داری نەخشکراو, دیکۆری کتێبخانە, پارچەی هونەری, کارامەیی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-185_qek7gg"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-185_qek7gg"
  },
  {
    id: "HOA-FINE-177",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "نحاس, عمل فني, نحت معدني, فن تجريدي, قطعة بحرية, مجسم",
      en: "copper sculpture, metal artwork, abstract art, maritime inspired sculpture, collectible art, fine metal art",
      ku: "مس, کاری هونەری, نحتی کانزایی, هونەری ئەبستراکت, پەیکەری دریایی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-177_nmyqjj"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-177_nmyqjj"
  },
  {
    id: "HOA-CRY-226",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "فازة حجرية, حجر منحوت, ديكور كلاسيكي, فازة أوروبية, قطعة عرض, تحفة حجرية",
      en: "stone vase, carved stone, classical decor, european style vase, display object, stone collectible",
      ku: "فازەی بەردی, بەردی نەخشکراو, دیکۆری کلاسیکی, پارچەی پیشاندان, تحفەی بەردی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cry-226_ufa6b9",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cry-226-1_klacvr"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cry-226_ufa6b9"
  },
  {
    id: "HOA-FINE-221",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "عمل فني معدني, نحت معدني, قطعتين, فن أفريقي, ديكور رفوف, مجسم تجريدي",
      en: "metal sculpture set, two piece art, abstract metal figures, african inspired art, shelf decor, artistic sculpture",
      ku: "کاری هونەری ئاسنی, دوو پارچە, نحتی کانزایی, هونەری ئەفریقی, دیکۆری ناوخۆ"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-221_ujgugi"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-221_ujgugi",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "شخصية متأملة, نحت تجريدي, عمل فني, فن هادئ, قطعة عرض, مجسم معاصر",
      en: "contemplative figure, abstract sculpture, emotional artwork, modern sculpture, display art, figurative abstraction",
      ku: "کەسایەتی بیرکەرەوە, نحتی ئەبستراکت, کاری هونەری, پارچەی پیشاندان, مجسم"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-195_bbkn6o"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-195_bbkn6o",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "خط عربي, فن إسلامي, عمل جداري, ملعقة خشبية, زخرفة عربية, قطعة نادرة",
      en: "arabic calligraphy, islamic art, wall art, wooden spoon art, engraved wood, cultural heritage art",
      ku: "خەتی عەرەبی, هونەری ئیسلامی, کاری دیواری, قاشقی دار, پارچەی نادر"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-208_z0jrrp"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-208_z0jrrp",
    material: {
      ar: "خشب محفور يدويًا",
      en: "Hand-Carved Wood",
      ku: "دارەی دەست‌کەر"
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "طبل تقليدي, عمل فني تراثي, زخارف يدوية, فن شعبي, آلة موسيقية, قطعة ديكور",
      en: "traditional drum, folk art, hand painted drum, cultural artwork, musical heritage, decorative instrument",
      ku: "دەفێکی کەلتووری, کاری هونەری میراثی, نەخشەی دەستی, ئامێری مۆسیقی, پارچەی دیکۆری"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-206_qv2zbl"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-206_qv2zbl",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "نحت عضوي, عمل تأملي, قطعة فنية, فن معاصر, خامة طبيعية, مجسم مستقل",
      en: "organic sculpture, contemplative artwork, raw texture art, contemporary sculpture, standalone art, fine art object",
      ku: "نحتی ئۆرگانیک, کاری تەئەمولی, پارچەی هونەری, هونەری هاوچەرخ, مجسم"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-224_yje74t"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-224_yje74t",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "عمل نحتي موقّع, توقيع فنان, تمثال إنساني, قطعة فنية, قاعدة خشبية, اقتناء فني",
      en: "signed sculpture, figurative artwork, artist signature, human figure sculpture, collectible art, mounted sculpture",
      ku: "کاری نحتی مۆرکراو, واژۆی هونەرمەند, پەیکەری مرۆیی, پارچەی هونەری, کۆکردنەوەی هونەر"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-227_r94lmj"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-227_r94lmj",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "عمل فني صخري, نحت حجري, فن تجريدي, قطعة متحفية, abstract stone art, stone sculpture, fine art sculpture, contemporary art, کاری هونەری بەردی, نەتەوەیی هونەری",
      en: "abstract stone art, stone sculpture, fine art sculpture, contemporary art, museum display, carved stone artwork",
      ku: "کاری هونەری بەردی, نحتی بەردی, هونەری ئەبستراکت, پارچەی مۆزەیی, بەردی سرووشتی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-237_cdxdwn"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-237_cdxdwn"
  },
  {
    id: "HOA-FINE-229",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "فن جداري, معدن, عمل فني معاصر, قطعة جدارية, ديكور معدني, لوحة معدنية",
      en: "metal wall art, contemporary wall decor, decorative metal artwork, artistic wall piece, fine metal art, interior art",
      ku: "کاری دیواری کانزا, هونەری دیواری, پارچەی جیاواز, دیکۆری کانزایی, هونەری مۆدێرن"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-229_bfnusq"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-229_bfnusq"
  },
  {
    id: "HOA-FINE-238",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "مجموعة pins, عمل فني جداري, تحف عالمية, عرض متحفي, world pins collection, pin art display, fine art wall piece, museum display art, کۆمەڵە پینە جیهانییەکان",
      en: "world pins collection, wall art display, museum style pins, travel memorabilia art, collectible pin board, cultural artwork",
      ku: "کۆمەڵەی پینی جیهانی, کاری دیواری, عارضەی مۆزەیی, بیرەوەری گەشت, پارچەی هونەری"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-238.jppg_ihokye"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-238.jppg_ihokye"
  },
  {
    id: "HOA-FINE-257",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "عربة ملكية, خزف أوروبي, مجسم أنتيك, شخصيات أرستقراطية, ديكور كلاسيكي, تحفة نادرة",
      en: "royal carriage figurine, european porcelain, antique sculpture, aristocratic figures, classic decor, collectible art",
      ku: "عەرەبەی شاهانە, خەزەفی ئەورووپی, مجسمی ئانتیک, پارچەی دەگمەن, دیکۆری کلاسیکی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-257_i4aoka"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-257_i4aoka"
  },
  {
    id: "HOA-FINE-251",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "تمثال نصفي, أنتيك, نحت كلاسيكي, تحفة فنية, تمثال أوروبي, ديكور مكتبي",
      en: "antique bust, classical sculpture, european statue, artistic collectible, museum style decor, figurative art",
      ku: "پەیکەری سەر و شانە, ئانتیک, نحتی کلاسیکی, پارچەی هونەری, تمثال ئەورووپی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-251_vpsb5s"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-251_vpsb5s"
  },
  {
    id: "HOA-FINE-254",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "سيف أنتيك, سيف مزخرف, تحف تاريخية, أعمال فنية كلاسيكية, سلاح للعرض, قطعة نادرة",
      en: "antique sword, decorated blade, classical weapon art, historical collectible, display sword, rare artifact",
      ku: "شمشێری ئانتیک, تیغی نەقشدار, تحفەی مێژوویی, سلاحی پیشاندان, پارچەی نادر"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-254_npbj5c"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-254_npbj5c"
  },
  {
    id: "HOA-FINE-255",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "خنجر أنتيك, خنجر تقليدي, سلاح أبيض, قطعة تراثية, تحفة تاريخية, عرض متحفي",
      en: "antique dagger, traditional weapon, edged antique, heritage artifact, historical collectible, museum display",
      ku: "خەنجەری ئانتیک, سلاحی نەریتی, پارچەی تراثی, تحفەی مێژوویی, پیشاندانی مۆزەیی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-255_rpgomf"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-255_rpgomf"
  },
  {
    id: "HOA-FINE-267",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "تمثال خشبي, فن شرقي, قطعة أنتيك, ديكور ثقافي, نحت يدوي, شخصية جالسة",
      en: "antique wooden figure, eastern art, hand painted sculpture, cultural decor, seated figure, collectible statue",
      ku: "پەیکەری دار, هونەری ڕۆژهەڵاتی, پارچەی ئانتیک, نحتی دەستی, کاراکتەری دانیشتوو"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-267_adpogh"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-267_adpogh"
  },
  {
    id: "HOA-FINE-288",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "عربة رومانية, نحت كلاسيكي, تمثال حربي, فن أوروبي, قطعة متحفية, مجسم حصان",
      en: "roman chariot sculpture, classical art, war chariot statue, european collectible, museum figurine, horse sculpture",
      ku: "عەرەبەی ڕۆمانی, نحتی کلاسیکی, تمثال جەنگی, هونەری ئەورووپی, پارچەی مۆزەیی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-288_zpc2jh"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-288_zpc2jh"
  },
  {
    id: "HOA-FINE-284",
    category: {
    ...
    sourceCategory: "أعمال فنية جدارية",
    name: {
    ...
    status: "available",
    keywords: {
      ar: "أقنعة خشبية, فن جداري, نحت يدوي, ديكور جداري, wooden masks, wall art, hand carved wood",
      en: "wooden wall masks, hand carved masks, african inspired decor, tribal wall art, carved wood artwork, wall sculpture",
      ku: "ماسکی دار, کاری دیواری, نەقشی دەستی, هونەری ئەفریقی, پارچەی هەڵواسراو"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-284_ig8hl8"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-284_ig8hl8"
  },
  {
    id: "HOA-FINE-270",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "ساعة فنية, تمثال رومانسي, ديكور كلاسيكي, قطعة فنية, ساعة تمثال, عمل داخلي",
      en: "art clock, romantic sculpture, classical decor, figurative clock, interior artwork, collectible decor",
      ku: "کاتژمێری هونەری, پەیکەری ڕۆمانسی, دیکۆری کلاسیکی, پارچەی هونەری, کاری ناوخۆ"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-270_kwmmw7"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-270_kwmmw7"
  },
  {
    id: "HOA-FINE-274",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "طفلين على أرجوحة, تمثال أطفال, عمل رومانسي, ديكور كلاسيكي, فن أوروبي, قطعة فنية",
      en: "children on swing sculpture, figurative artwork, romantic decor, classical figurine, european art, collectible statue",
      ku: "منداڵان لەسەر هەڵمەت, پەیکەری منداڵ, هونەری ئەورووپی, پارچەی هونەری, دیکۆری رۆمانسی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-274_qe54px"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-274_qe54px"
  },
  {
    id: "HOA-WOOD-277",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "صندوق خشبي, صندوق اكسسوارات, تطعيم نحاس, درج داخلي, ديكور فاخر, قطعة عملية",
      en: "wooden accessory box, brass inlay box, jewelry box, luxury storage, decorative wood box, handcrafted box",
      ku: "سندوقی دار, ئاکسسوار, پێچراوی مۆر, داری ناوخۆ, دیکۆری فاخر, پارچەی کاری"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-277_os8l2k",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-277-1_e6oran",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-277-2_x8mylw"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-277_os8l2k"
  }
];